...
type: specification
created_date: '2026-08-14 16:05'
updated_date: '2026-08-14 16:05'
---
> **Imported verbatim from `~/repos/agent-fanout-generic.md` on 2026-08-14.** This in-repo copy is
> authoritative for `autopi-ha`: an agent with only this checkout has the whole model. Do not
> summarise, compress or "adapt" it here. When the source changes, the change is not finished until
> every consuming repo has been re-imported in the same commit.
